...
function rootModuleEnabled(name,rootConfig){if(name==='security')return rootConfig.security?.enabled===true||rootConfig.honeypot?.enabled===true;if(name==='honeypot')return rootConfig.honeypot?.enabled===true&&rootConfig.security?.enabled!==true;return rootConfig[name]?.enabled===true;}
