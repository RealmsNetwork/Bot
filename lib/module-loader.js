...
const ADVANCED_TEMPLATE=`# RealmsNetwork Bot v0.1 advanced module configuration
# Generated only when config.yml contains: advanced: true
# Advanced mode is intentionally comprehensive. Existing files are never overwritten.
schemaVersion: 2
module:
  enabled: true
  mode: production
...
http:
  ...
  allowedHosts: []
  headers: {}
  userAgent: RealmsNetwork-Bot/0.1
webhooks:
  enabled: false
  urls: {}
  defaultHeaders: {}
