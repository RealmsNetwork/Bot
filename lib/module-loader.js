...
function rootModuleEnabled(name,rootConfig){if(name==='honeypot')return false;if(name==='security')return rootConfig.security?.enabled===true||rootConfig.honeypot?.enabled===true;return rootConfig[name]?.enabled===true;}
